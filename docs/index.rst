...
.. code-block:: python
   ...
   trained_model = number_magic.models.ExponentialDecay().fit(points_in_time, labels)
...
- Issue Tracker: https://github.com/lampenlars/number_magic/-/issues
- Source Code: https://github.com/lampenlars/number_magic
